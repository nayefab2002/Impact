...
class EventFormCard extends StatelessWidget {
              ...
              Row(
                children: [
                  ...
                  buildStatItem(
                    ...
                    value: DateFormat('MMM dd').format(DateTime.parse(form.dateTime)),
                    label: 'Date',
                  ),
                  const SizedBox(width: 20),
                  IconButton(onPressed: (){
                    String copyLink="https://impact.web.app/events/${form.id}";
