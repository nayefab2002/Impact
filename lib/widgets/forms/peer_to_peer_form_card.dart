...
class PeerToPeerFormCard extends StatelessWidget {
  final PeerToPeerForm form;
  final VoidCallback onEdit;
  final VoidCallback onView;

  const PeerToPeerFormCard({
    super.key,
    required this.form,
              ...
              Row(
                children: [
                  ...
                  buildStatItem(
                    ...
                    value: NumberFormat.simpleCurrency().format(350),
                    label: 'Raised',
                  ),
                  const SizedBox(width: 16),
                  buildStatItem(
                  ...
                  IconButton(onPressed: (){
                    String copyLink="https://impact.web.app/peer_to_peers/${form.id}";
